...
!function(a) {
    ...
    var h = {tagClass: function() {
            ...
            return null
        }, freeInput: !0, addOnBlur: !0, maxTags: void 0, maxChars: void 0, confirmKeys: [13, 44], onTagExists: function(a, b) {
            b.hide().fadeIn()
        }, trimValue: !1, allowDuplicates: !1};
    b.prototype = {constructor: b, add: function(b, c, d) {
            var f = this;
            if (!(f.options.maxTags && f.itemsArray.length >= f.options.maxTags || b !== !1 && !b)) {
                ...
                if (!b.toString().match(/^\s*$/)) {
                    ...
                    var i = f.options.itemValue(b), j = f.options.itemText(b), k = f.options.tagClass(b), l = f.options.itemTitle(b), m = a.grep(f.itemsArray, function(a) {
                    ...
                    if (!m || f.options.allowDuplicates) {
                        if (!(f.items().toString().length + b.length + 1 > f.options.maxInputLength)) {
                            ...
                            if (f.$element.trigger(n), !n.cancel) {
                                ...
                                c || f.pushVal(), (f.options.maxTags === f.itemsArray.length || f.items().toString().length === f.options.maxInputLength) && f.$container.addClass("bootstrap-tagsinput-max"), f.$element.trigger(a.Event("itemAdded", {item: b, options: d}))
                            }
                        }
            ...
            if (e.options = a.extend({}, h, b), e.objectItems && (e.options.freeInput = !1), c(e.options, "itemValue"), c(e.options, "itemText"), d(e.options, "tagClass"), e.options.typeahead) {
                ...
                d(i, "source"), e.$input.typeahead(a.extend({}, i, {source: function(b, c) {
                        function d(a) {
                    ...
                    if (m = n[s], e.isArray(m))
                        ...
                        switch (i = "", d = "", m) {
                            case"ellipsis":
                                ...
                                break;
                            case"first":
                                i = b.sFirst, d = m + (r > 0 ? "" : " disabled");
                                break;
                            case"previous":
                                i = b.sPrevious, d = m + (r > 0 ? "" : " disabled");
                                break;
                            case"next":
                                i = b.sNext, d = m + (l - 1 > r ? "" : " disabled");
                                break;
                            case"last":
                                i = b.sLast, d = m + (l - 1 > r ? "" : " disabled");
                                break;
                            default:
                                i = m + 1, d = r === m ? "active" : ""
                        }
                        i && (T = e("<li>", {"class": u.sPageButton + " " + d, "aria-controls": a.sTableId, tabindex: a.iTabIndex, id: 0 === o && "string" == typeof m ? a.sTableId + "_" + m : null}).append(e("<a>", {href: "#"}).html(i)).appendTo(t), a.oApi._fnBindAction(T, {action: m}, g))
                    }
            };
            p(e(n).empty().html('<ul class="pagination"/>').children("ul"), s)
        }, t.TableTools && (e.extend(!0, t.TableTools.classes, {container: "DTTT btn-group", buttons: {normal: "btn btn-default", disabled: "disabled"}, collection: {container: "DTTT_dropdown dropdown-menu", buttons: {normal: "", disabled: "disabled"}}, print: {info: "DTTT_print_info"}, select: {row: "active"}}), e.extend(!0, t.TableTools.DEFAULTS.oTags, {collection: {container: "ul", button: "li", liner: "a"}}))
    };
...
/*! social-share-js - v1.0.3 - 2015-05-28
...
!function(a) {
    a.fn.socialShare = function(b) {
        function c(a) {
            if (b.toWord) {
                if (a >= 1e9)
                    return(a / 1e9).toFixed(1) + "G";
                if (a >= 1e6)
                    return(a / 1e6).toFixed(1) + "M";
                if (a >= 1e3)
                    return(a / 1e3).toFixed(1) + "K"
            }
            return a
        }
        var d = {url: window.location.href, description: a("meta[name=description]").attr("content"), title: a("title").text(), counts: !0, twitter: !0, facebook: !0, pinterest: !0, linkedIn: !0, gPlus: !0, image: null, toWord: !0, twitterVia: null, twitterHashTags: null}, e = this;
        return b = jQuery.extend({}, d, b), this.each(function() {
            ...
            var g = {all: {getCount: function(a) {
                        var b = jQuery.Deferred(), c = {};
                        return jQuery.getJSON("https://count.donreach.com/?url=" + encodeURIComponent(a.url) + "&callback=?", function(a) {
                            c.url = a.url, c.facebook = a.shares.facebook, c.twitter = a.shares.twitter, c.linkedIn = a.shares.linkedin, c.pinterest = a.shares.pinterest, c.gPlus = a.shares.google, c.success = !0, b.resolve(c)
                        }).fail(function(a, d, e) {
                            alert(e), c.success = !1, b.resolve(c)
                        }), b.promise()
                    }}, twitter: {getCount: function(a, b) {
                    ...
                    }}, facebook: {getCount: function(a, b) {
                        var c = jQuery.Deferred();
                    ...
                    }}, pinterest: {getCount: function(a, b) {
                        var c = jQuery.Deferred();
                    ...
                    }}, linkedIn: {getCount: function(a, b) {
                        var c = jQuery.Deferred();
                        ...
                        return jQuery.getJSON("http://anyorigin.com/get?callback=?&url=" + encodeURIComponent("https://plusone.google.com/_/+1/fastbutton?url=" + a.url), function(a) {
                            b.gPlus = parseFloat(a.contents.match(/\{c: [0-9A-Z.]+/)[0].split(" ")[1]), c.resolve(b)
                        }), c.promise()
                    }}}, h = {};
            b.counts ? g.all.getCount(b).then(function(c) {
                h = c, c.success ? d(h) : a.when(b.facebook ? g.facebook.getCount(b, h) : null, b.twitter ? g.twitter.getCount(b, h) : null, b.pinterest ? g.pinterest.getCount(b, h) : null, b.linkedIn ? g.linkedIn.getCount(b, h) : null, b.gPlus ? g.gPlus.getCount(b, h) : null).then(function() {
                    d(h)
                })
            }) : d();
            var i = {width: 626, height: 336, left: a(window).width() / 2 - 313, top: a(window).height() / 3 - 168}
        })
    }
}(jQuery);
/*!
...
!function(e, i) {
    ...
    return i.prototype.onChange = function() {
        ...
        if (0 !== this.settings.maxFileSize) {
            var i = this.settings.maxFileSize.slice(-1).toUpperCase(), t = 1024, s = 1024 * t, r = 1024 * s;
...
$("[rel='tooltip']").tooltip(), $(".list-thumbnail").hover(function() {
    $(this).find(".list-caption").slideDown(250)
}, function() {
    $(this).find(".list-caption").slideUp(250)
}), $('a[data-link-type="list-modal"]').click(function() {
    $("#myModal #myModalTitle").text($(this).attr("data-img-title")), $("#myModal img").attr("src", $(this).attr("data-img-url")), $("#myModal #modalDownloadBtn").attr("href", $(this).attr("data-img-url")), $("#myModal #modalTagWrapper").html("<h4>" + $(this).closest(".caption").find(".tagsWrapper").html() + "<h4>")
}), $.fn.dataTableExt.sErrMode = "throw", $(document).on("click", ".delete-button", function() {
    return confirm("Are you sure you want to delete this photo?")
}), $(".dropify").dropify(), $('div[data-group="share-buttons"] input[type="text"]').click(function() {
    $(this).focus().select()
}), $(document).on("click", 'a[data-modal-type="admin-modal"]', function() {
    $("#myModal #myModalTitle").text($(this).attr("data-img-title")), $("#myModal img").attr("src", $(this).attr("data-img-url")), $("#myModal #modalDownloadBtn").attr("href", $(this).attr("data-img-url"))
}), $("#admin-photos-table").on("order.dt", function() {
    triggerTooltip()
}).on("search.dt", function() {
    triggerTooltip()
}).on("page.dt", function() {
    triggerTooltip()
}).DataTable({processing: !0, serverSide: !0, ajax: $("#admin-photos-table").attr("data-source"), columns: [{data: "id"}, {data: "image", orderable: !1, searchable: !1}, {data: "title"}, {data: "name"}, {data: "created_at"}, {data: "updated_at"}, {data: "action", name: "action", orderable: !1, searchable: !1}], fnInitComplete: function() {
        triggerTooltip()
    }}), $("#admin-users-table").DataTable({processing: !0, serverSide: !0, ajax: $("#admin-users-table").attr("data-source"), columns: [{data: "id", name: "id"}, {data: "name", name: "name"}, {data: "email", name: "email"}, {data: "role", name: "role"}, {data: "created_at", name: "created_at"}, {data: "updated_at", name: "updated_at"}, {data: "action", name: "action", orderable: !1, searchable: !1}]});